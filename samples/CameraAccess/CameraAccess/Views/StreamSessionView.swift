  ...
  var body: some View {
    ZStack {
      if viewModel.isStreaming {
        ...
        StreamView(viewModel: viewModel, wearablesVM: wearablesViewModel, geminiVM: geminiVM, webrtcVM: webrtcVM, transcriptionVM: transcriptionVM)
      } else {
    ...
    .task {
      ...
      transcriptionVM.streamingMode = viewModel.streamingMode
    }
    .onChange(of: viewModel.streamingMode) { newMode in
      geminiVM.streamingMode = newMode
      transcriptionVM.streamingMode = newMode
    }
    .onAppear {
